...
export const Route = createFileRoute("/courses/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Browse every finance course on StocksTrail Learning. Filter by difficulty, category and reading time." },
      { property: "og:title", content: "All Courses — StocksTrail Learning" },
      { property: "og:description", content: "Browse every finance course on StocksTrail Learning." },
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-6xl px-5 sm:px-8 lg:px-12 pt-14 pb-8">
          <nav aria-label="Breadcrumb" className="text-xs text-white/50">
            <Link to="/" className="hover:text-white">Home</Link> <span className="mx-1">/</span> <span className="text-white/80">Courses</span>
          </nav>
