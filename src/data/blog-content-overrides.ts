export const BLOG_CONTENT_OVERRIDES: Record<string, string> = {
  'sebi-mutual-fund-nomination-rule-september-2026': `# SEBI's New Mutual Fund Nomination Rule 2026: What You Must Do Before September 1
...
This guide walks through what **SEBI's new mutual fund nomination rule** actually changes, who needs to act and by when, and the fastest way to add or update a nominee online, whether you invest directly, through an app, or through a certified [mutual fund advisor](/services/mutual-funds).
