      ...
      <div className="max-w-7xl mx-auto space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-12">
          ...
          <div className="lg:col-span-4 space-y-5">
            ...
            {/* Regulatory & Preferred Source Badges */}
            <div className="space-y-2">
              ...
              {/* Follow on Google News / Preferred Source Link */}
              <a
                href="https://news.google.com/search?q=Stockstrail%20mutual%20funds&hl=en-IN&gl=IN&ceid=IN%3Aen"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/[0.04] hover:bg-[#00ff97]/15 border border-white/10 hover:border-[#00ff97]/40 text-white/80 hover:text-white text-xs font-product-sans transition-all"
              >
                ...
                <span className="text-[11px] font-medium">Preferred Source on Google News</span>
              </a>
            </div>
