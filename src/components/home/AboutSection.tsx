                    ...
                    <div className="bg-[#021716]/85 border border-white/12 rounded-3xl p-6 sm:p-8 backdrop-blur-xl shadow-[0_15px_35px_rgba(0,0,0,0.6),inset_0_1px_1px_rgba(255,255,255,0.1)] space-y-6">
                        ...
                        <div className="pt-4 border-t border-white/10">
                            <p className="text-white/80 text-xs sm:text-sm leading-relaxed">
                                Today, Stockstrail serves 200+ investors across Himachal Pradesh and clients across India with services covering <Link href="/services/mutual-funds" className="text-stockstrail-green-light font-semibold hover:underline">mutual funds</Link>, <Link href="/services/insurance" className="text-stockstrail-green-light font-semibold hover:underline">insurance</Link>, <Link href="/services/fixed-deposit" className="text-stockstrail-green-light font-semibold hover:underline">fixed deposits</Link>, <Link href="/services/loan" className="text-stockstrail-green-light font-semibold hover:underline">loans</Link>, and <Link href="/services/open-demat" className="text-stockstrail-green-light font-semibold hover:underline">demat accounts</Link>.
                            </p>
                        </div>
                    </div>
                </div>
