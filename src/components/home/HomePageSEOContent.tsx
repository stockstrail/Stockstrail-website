        ...
        <section className="py-16 sm:py-24 relative overflow-hidden isolate defer-render">
            ...
            <div className="max-w-[90%] lg:max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16 relative z-10">
                ...
                <div className="bg-[#021716]/85 border border-white/12 rounded-3xl p-6 sm:p-8 backdrop-blur-xl shadow-[0_15px_35px_rgba(0,0,0,0.6),inset_0_1px_1px_rgba(255,255,255,0.1)] space-y-6">
                    ...
                    <p className="text-white/85 leading-relaxed text-sm sm:text-base font-normal">
                        Whether starting a disciplined <Link href="/services/mutual-funds" className="text-stockstrail-green-light hover:underline font-semibold">Mutual Fund SIP</Link>, booking secure <Link href="/services/fixed-deposit" className="text-stockstrail-green-light hover:underline font-semibold">high-interest Fixed Deposits</Link>, comparing comprehensive <Link href="/services/insurance" className="text-stockstrail-green-light hover:underline font-semibold">Term &amp; Health Insurance policies</Link>, accessing liquidity via a <Link href="/services/loan" className="text-stockstrail-green-light hover:underline font-semibold">Loan Against Mutual Funds (LAMF)</Link>, or getting ready to <Link href="/services/open-demat" className="text-stockstrail-green-light hover:underline font-semibold">open a digital Demat Account</Link>, Stockstrail provides unbiased, transparent guidance every step of the way.
                    </p>
                    ...
                    <div className="pt-4 border-t border-white/10">
                        ...
                        <div className="flex flex-wrap gap-2.5 sm:gap-3 text-xs sm:text-sm">
                            <Link href="/services/mutual-funds" className="inline-flex items-center min-h-[44px] px-4 py-2 rounded-full bg-white/5 border border-white/10 text-white/80 hover:text-stockstrail-green-light hover:border-stockstrail-green-light/40 transition-colors">Mutual Funds Guide</Link>
                            <Link href="/services/fixed-deposit" className="inline-flex items-center min-h-[44px] px-4 py-2 rounded-full bg-white/5 border border-white/10 text-white/80 hover:text-stockstrail-green-light hover:border-stockstrail-green-light/40 transition-colors">FD Rates 2026</Link>
                            <Link href="/services/insurance" className="inline-flex items-center min-h-[44px] px-4 py-2 rounded-full bg-white/5 border border-white/10 text-white/80 hover:text-stockstrail-green-light hover:border-stockstrail-green-light/40 transition-colors">Term &amp; Health Insurance</Link>
                            <Link href="/services/loan" className="inline-flex items-center min-h-[44px] px-4 py-2 rounded-full bg-white/5 border border-white/10 text-white/80 hover:text-stockstrail-green-light hover:border-stockstrail-green-light/40 transition-colors">Loans Against Mutual Funds</Link>
                            ...
                            <Link href="https://learning.stockstrail.in" className="inline-flex items-center min-h-[44px] px-4 py-2 rounded-full bg-white/5 border border-white/10 text-white/80 hover:text-stockstrail-green-light hover:border-stockstrail-green-light/40 transition-colors">Learning Center</Link>
