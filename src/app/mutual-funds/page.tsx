...
const faqJsonLd = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'The value of your mutual fund investment can fall when markets decline. A market correction does not automatically mean that you should stop your SIP. Your decision should be based on your goals, risk profile and investment horizon rather than short-term market movements. A SIP continues according to its schedule unless you stop or pause it.',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Both Direct and Regular Plans invest in the same underlying mutual fund scheme and are managed by the same fund manager. Direct Plans do not involve a distributor and generally have a lower expense ratio, while Regular Plans include distribution expenses and are purchased through a mutual fund distributor. The choice should also consider the level of service and support an investor wants.',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: "An exit load is a fee that may apply when you redeem mutual fund units within a specified period. The amount and applicable period depend on the particular scheme, so always check the scheme's current exit-load terms before redeeming or switching. Not every mutual fund has the same exit-load structure.",
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: "Not necessarily. Switching only because another fund has recently delivered higher returns can lead to unnecessary changes and may have tax or exit-load implications. Before switching, consider whether your existing fund still fits your goals, risk profile, investment horizon and the fund's investment objective rather than focusing only on recent performance.",
      },
    },
    {
      '@type': 'Question',
